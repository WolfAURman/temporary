# sync rom
repo init --depth=1 --no-repo-verify repo init -u git://github.com/LineageOS/android.git -b lineage-19.1 -g default,-mips,-darwin,-notdefault
git clone https://github.com/WolfAURman/local_manifest.git --depth 1 -b los19.1-mt6768PHQ .repo/local_manifests
